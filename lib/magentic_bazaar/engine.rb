    ...
    initializer "magentic_bazaar.configure_multistore", after: :load_config_initializers do
      if MagenticBazaar.configuration&.multistore_enabled
        ...
        ActiveSupport.on_load(:active_record) do
          [MagenticBazaar::Document, MagenticBazaar::Skill, MagenticBazaar::UmlDiagram, MagenticBazaar::McpServer, MagenticBazaar::McpProvider, MagenticBazaar::SkillServer, MagenticBazaar::SkillProvider].each do |klass|
